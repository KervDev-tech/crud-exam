    ...
    <div class="main">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="s_title" id="s_title" placeholder="enter title..."
                    required>
            </div>
            <div class="mb-3">
                <label for="s_artist" class="form-label">Artist</label>
                <input type="text" class="form-control" name="s_artist" id="s_artist" placeholder="enter artist..."
                    required>
            </div>
            <div class="mb-3">
